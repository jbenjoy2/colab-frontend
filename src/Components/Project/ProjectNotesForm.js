  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
      <div className="form-group">
        <label htmlFor="notes">
          <h2 className="text-center display-4" style={{ color: "#f47b33" }}>
            Song Notes
          </h2>
        </label>
        <RichTextEditor
        ...
        {currentUser.username === props.owner && (
          <>
            <button
              onClick={toggle}
              type="button"
              className="btn btn-danger mx-2 mx-lg-5"
            >
              Delete
            </button>
            <Modal
